! function(r) { "use strict";
        ...
        a.addData(t), a.make(), o = o || 0; var u = a.getModuleCount(),
            ...
            c = function(r, t, e, n) { var o = this.isDark,
                ...
                this.isDark = function(a, u) { var f = u * i,
                        c = a * i,
                        l = f + i,
                        s = c + i; return o(a, u) && (r > l || f > e || t > s || c > n) } };
    ...
    function c(r, t, e, n, o, i, a, c) { var l = r.isDark,
            s = n + i,
            d = o + i,
            h = e.radius * i,
            g = a - 1,
    ...
    function l(r, t, e) { var n, o, i = r.moduleCount,
            u = e.size / i,
            f = a; for (m && e.radius > 0 && e.radius <= .5 && (f = c), t.beginPath(), n = 0; i > n; n += 1)
            for (o = 0; i > o; o += 1) { var l = e.left + o * u,
                    s = e.top + n * u,
                    d = u;
                f(r, t, e, l, s, d, n, o) }
    ...
    function s(r, t) { var n = e(t.text, t.ecLevel, t.minVersion, t.maxVersion, t.quiet); if (!n) return null; var o = w(r).data("qrcode", n),
            a = o[0].getContext("2d"); return i(n, a, t), l(n, a, t), o }

    function d(r) { var t = w("<canvas/>").attr("width", r.size).attr("height", r.size); return s(t, r) }
    ...
    function g(r) { var t = e(r.text, r.ecLevel, r.minVersion, r.maxVersion, r.quiet); if (!t) return null; var n, o, i = r.size,
            ...
            h = w("<div/>").data("qrcode", t).css(s); for (a && h.css("background-color", a), n = 0; f > n; n += 1)
            for (o = 0; f > o; o += 1) t.isDark(n, o) && w("<div/>").css(d).css({ left: l + o * c, top: l + n * c }).appendTo(h); return h }
    ...
    w.fn.qrcode = function(r) { var t = w.extend({}, T, r); return this.each(function() { "canvas" === this.nodeName.toLowerCase() ? s(this, t) : w(this).append(v(t)) }) } }(function() { var r = function() {
        function r(t, e) { if ("undefined" == typeof t.length) throw new Error(t.length + "/" + e); var n = function() { for (var r = 0; r < t.length && 0 == t[r];) r += 1; for (var n = new Array(t.length - r + e), o = 0; o < t.length - r; o += 1) n[o] = t[o + r]; return n }(),
                ...
                w = new Array,
                p = {},
                m = function(r, t) { h = 4 * l + 17, d = function(r) { for (var t = new Array(r), e = 0; r > e; e += 1) { t[e] = new Array(r); for (var n = 0; r > n; n += 1) t[e][n] = null } return t }(h), T(0, 0), T(h - 7, 0), T(0, h - 7), A(), E(), k(r, t), l >= 7 && B(r), null == v && (v = b(l, s, w)), C(v, t) },
                ...
                A = function() { for (var r = i.getPatternPosition(l), t = 0; t < r.length; t += 1)
                        for (var e = 0; e < r.length; e += 1) { var n = r[t],
                                o = r[e]; if (null == d[n][o])
                                for (var a = -2; 2 >= a; a += 1)
                                    for (var u = -2; 2 >= u; u += 1) - 2 == a || 2 == a || -2 == u || 2 == u || 0 == a && 0 == u ? d[n + a][o + u] = !0 : d[n + a][o + u] = !1 } },
                B = function(r) { for (var t = i.getBCHTypeNumber(l), e = 0; 18 > e; e += 1) { var n = !r && 1 == (t >> e & 1);
                        d[Math.floor(e / 3)][e % 3 + h - 8 - 3] = n } for (var e = 0; 18 > e; e += 1) { var n = !r && 1 == (t >> e & 1);
                        d[e % 3 + h - 8 - 3][Math.floor(e / 3)] = n } },
                k = function(r, t) { for (var e = s << 3 | t, n = i.getBCHTypeInfo(e), o = 0; 15 > o; o += 1) { var a = !r && 1 == (n >> o & 1);
                ...
                C = function(r, t) { for (var e = -1, n = h - 1, o = 7, a = 0, u = i.getMaskFunction(t), f = h - 1; f > 0; f -= 2)
                        for (6 == f && (f -= 1);;) { for (var c = 0; 2 > c; c += 1)
                                if (null == d[n][f - c]) { var l = !1;
                                    a < r.length && (l = 1 == (r[a] >>> o & 1)); var s = u(n, f - c);
                                    s && (l = !l), d[n][f - c] = l, o -= 1, -1 == o && (a += 1, o = 7) }
                            if (n += e, 0 > n || n >= h) { n -= e, e = -e; break } } },
                M = function(t, e) { for (var n = 0, o = 0, a = 0, u = new Array(e.length), f = new Array(e.length), c = 0; c < e.length; c += 1) { var l = e[c].dataCount,
                            s = e[c].totalCount - l;
                        o = Math.max(o, l), a = Math.max(a, s), u[c] = new Array(l); for (var d = 0; d < u[c].length; d += 1) u[c][d] = 255 & t.getBuffer()[d + n];
                ...
                b = function(r, t, e) { for (var n = u.getRSBlocks(r, t), c = f(), l = 0; l < e.length; l += 1) { var s = e[l];
                        c.put(s.getMode(), 4), c.put(s.getLength(), i.getLengthInBits(s.getMode(), r)), s.write(c) } for (var d = 0, l = 0; l < n.length; l += 1) d += n[l].dataCount; if (c.getLengthInBits() > 8 * d) throw new Error("code length overflow. (" + c.getLengthInBits() + ">" + 8 * d + ")"); for (c.getLengthInBits() + 4 <= 8 * d && c.put(0, 4); c.getLengthInBits() % 8 != 0;) c.putBit(!1); for (; !(c.getLengthInBits() >= 8 * d) && (c.put(o, 8), !(c.getLengthInBits() >= 8 * d));) c.put(a, 8); return M(c, n) }; return p.addData = function(r) { var t = c(r);
        ...
        t.stringToBytes = function(r) { for (var t = new Array, e = 0; e < r.length; e += 1) { var n = r.charCodeAt(e);
                t.push(255 & n) } return t }, t.createStringToBytes = function(r, t) { var e = function() { for (var e = d(r), n = function() { var r = e.read(); if (-1 == r) throw new Error; return r }, o = 0, i = {};;) { var a = e.read(); if (-1 == a) break; var u = n(),
                            ...
                            s = f << 8 | c;
                        i[l] = s, o += 1 } if (o != t) throw new Error(o + " != " + t); return i }(),
            ...
            i = function() { var t = [
                    ...
                    for (var n = 0; t > n; n += 1)
                        ...
                        for (var n = 0; t > n; n += 1) r.isDark(n, o) && (l += 1); var s = Math.abs(100 * l / t / t - 50) / 5; return e += 10 * s }, f }(),
            ...
            u = function() { var r = [
                    ...
                    o = function(t, e) { switch (e) {
                        ...
                        for (var f = n[3 * u + 0], c = n[3 * u + 1], l = n[3 * u + 2], s = 0; f > s; s += 1) a.push(t(c, l)); return a }, e }(),
                ...
                i.setPixel = function(r, t, n) { o[t * e + r] = n }, i.write = function(r) { r.writeString("GIF87a"), r.writeShort(e), r.writeShort(n), r.writeByte(128), r.writeByte(0), r.writeByte(0), r.writeByte(0), r.writeByte(0), r.writeByte(0), r.writeByte(255), r.writeByte(255), r.writeByte(255), r.writeString(","), r.writeShort(0), r.writeShort(0), r.writeShort(e), r.writeShort(n), r.writeByte(0); var t = 2,
                    ...
                    u = function(r) { for (var t = 1 << r, e = (1 << r) + 1, n = r + 1, i = f(), u = 0; t > u; u += 1) i.add(String.fromCharCode(u));
                        ...
                        s.write(t, n); var d = 0,
                            ...
                            d += 1, i.contains(h + g) ? h += g : (s.write(i.indexOf(h), n), i.size() < 4095 && (i.size() == 1 << n && (n += 1), i.add(h + g)), h = g) } return s.write(i.indexOf(h), n), s.write(e, n), s.flush(), c.toByteArray() },
                    f = function() { var r = {},
                            t = 0,
            ...
            g = function(r, t, e, n) { for (var o = h(r, t), i = 0; t > i; i += 1)
                    for (var a = 0; r > a; a += 1) o.setPixel(a, i, e(a, i)); var u = l();
                o.write(u); for (var f = s(), c = u.toByteArray(), d = 0; d < c.length; d += 1) f.writeByte(c[d]);
...
function(r) { r.fn.share = function(t, e) {
        function n(t, e) { var n = i(e.sites, e.disabled); for ($i in n) { var o = n[$i],
                    u = a(o, e),
                    f = e.initialized ? t.find(".icon-" + o) : r('<a href="javascript:;" class="iconfont icon-' + o + '" target="_blank"></a>');
                f.length && (f.attr("href", u), t.append(f)) } }

        function o(r, t) { var e = r.find("a.icon-wechat");
            e.append('<div class="wechat-qrcode"><h4>' + t.wechatQrcodeTitle + '</h4><div class="qrcode"></div><div class="help">' + t.wechatQrcodeHelper + "</div></div>"), e.find(".qrcode").qrcode({ size: 100, text: t.url }) }

        function i(r, t) { return "string" == typeof r && (r = r.split(",")), "string" == typeof t && (t = t.split(",")), r.filter(function(r) { return !(t.indexOf(r) > -1) }).concat(t.filter(function(t) { return !(r.indexOf(t) > -1) })) }

        function a(r, t) { var e = l[r];
            t.summary = t.description; for ($key in t) { var n = r + $key.replace(/^[a-z]/, function(r) { return r.toUpperCase() }),
                    o = encodeURIComponent(t[n] || t[$key]);
                e = e.replace(new RegExp("{{" + $key.toUpperCase() + "}}", "g"), o) } return e } var u = r(document).find("img:first").prop("src"),
            f = { url: window.location.href, site_url: window.location.origin, source: r(document.head).find('[name="site"]').attr("content") || r(document.head).find('[name="Site"]').attr("content") || document.title, title: r(document.head).find('[name="title"]').attr("content") || r(document.head).find('[name="Title"]').attr("content") || document.title, description: r(document.head).find('[name="description"]').attr("content") || r(document.head).find('[name="Description"]').attr("content"), image: u ? u : "", wechatQrcodeTitle: "微信扫一扫：分享", wechatQrcodeHelper: "<p>微信里点“发现”，扫一下</p><p>二维码便可将本文分享至朋友圈。</p>", sites: ["weibo", "qq", "wechat", "tencent", "douban", "qzone", "linkedin", "diandian", "facebook", "twitter", "google"], disabled: [], initialized: !1 },
            c = r.extend(!0, f, e),
        ...
        this.each(function() { var t = r.extend({}, c, r(this).data() || {}),
                e = r(this).addClass("share-component");
            n(e, t), o(e, t) }) }, r(".share-component").share() }(jQuery);